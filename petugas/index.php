...
session_start();
if (!isset($_SESSION['petugas_id']) || $_SESSION['petugas_role'] !== 'petugas') {
...
?>
<h1 class="mx-auto font-bold text-blue-700 mt-20 font-width-100px">INI BUKU YANG KITA PUNYA MAS PETUGAS</h1>
