...
$ambil = "SELECT peminjaman.status, buku.pengarang,buku.judul,buku.cover, buku.pengarang, buku.tahun, kategori.id, kategori.kategori, user.nama AS namap, peminjaman.tanggal_pinjam, peminjaman.tanggal_kembali
          FROM peminjaman
    ...
    <tbody>
        ...
        while ($buku = mysqli_fetch_assoc($wadah)) : ?>
            <tr>
                ...
                <td class="border border-blue-700 px-4 py-2 bg-white text-black"><?= $buku['namap']; ?></td>
