    ...
    <tbody>
        ...
        while ($buku = mysqli_fetch_assoc($wadah)) : ?>
            <tr>
                ...
                <td class="border border-blue-700 px-4 py-2 bg-white text-black"><a href="../admin/edit.php?id_buku=<?= $buku['id']; ?>" class="text-lg font-bold text-green-700">Edit</a> <a href="../admin/hapus.php?id_buku=<?= $buku['id']; ?>" class="text-lg font-bold text-red-700">Hapus</a></td>
            </tr>
    </tbody>
<?php endwhile ?>
</table>