...
$pinjaman = mysqli_query($kon, "SELECT peminjaman.status, peminjaman.id AS peminjaman_id, buku.id AS buku_id,peminjaman.tanggal_pinjam,buku.cover, buku.judul, buku.pengarang, buku.penerbit, buku.tahun , kategori.kategori
FROM peminjaman
...
<table class="mx-auto my-4">
    <thead>
        <tr>
            ...
            <td class="border border-blue-400 px-4 py-2 bg-blue-700 text-white">Tanggal Peminjaman</td>
